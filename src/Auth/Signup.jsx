...
const getSignupErrorMessage = (error) => {
  ...
  if (error?.request) {
    return "Could not get signup response. Check the mobile API IP and backend server.";
  }
...
const Signup = () => {
  ...
  const handleApiOriginSave = () => {
    ...
    if (!normalizedOrigin) {
      localStorage.removeItem(MOBILE_API_OVERRIDE_STORAGE_KEY);
      setApiOrigin("");
    ...
    localStorage.setItem(MOBILE_API_OVERRIDE_STORAGE_KEY, normalizedOrigin);

...
import { Search, Send, Smile, Paperclip, Plus, X, Users, Check, Loader2, Trash2 } from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';
import { getStaffList,createChatRoom,getChatRooms,getRoomMessages ,deleteRoom } from '../services/Chat.services';
...
const fetchEmployees = async () => {
  try {
    ...
    const formatted = data
     .filter(staff => staff.status === "ACTIVE" && staff.id !== currentUserId)
      .map(staff => ({
        userId: staff.id,
        userName: staff.name,
        userRole: staff.role
...
const handleSendMessage = (e) => {
  ...
  sendChatMessage(selectedConversation.id, {
